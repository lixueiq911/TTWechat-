<template>
    <div class="saleM2" v-show="init">
        <v-header>售点积分排名</v-header>
        <div class="search">
            <mt-search cancel-text="取消" placeholder="M1姓名" v-model="m1Name"
            ...
            <div class="tBody">
                <ul class="tul">
                    <li class="tli" v-for="item in saleList" @click="seeDetails(item.userId)">
                        ...
                        <span class="li_span4 cort">{{item.monthSales}}箱/{{item.monthStandardSales}}标箱</span>
                    </li>
                </ul>
            </div>
        </div>
