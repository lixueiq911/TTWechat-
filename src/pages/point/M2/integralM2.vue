<template>
    <div class="pointM1_M2" v-show="init">
        ...
        <div class="cont_M2">
            ...
            <div class="tBody">
                <ul class="tul">
                    <li class="tli" v-for="item in integralList" @click="seeDetails(item.salesmanId)">
                        ...
                        <span class="li_span3 cort">{{item.averagePoints}}</span>
...
<script>
    export {default} from "../js/integralM2";
</script>
